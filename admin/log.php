...
// Query JOIN untuk mendapatkan nama lengkap user bersama setiap entri log
// Diurutkan dari yang paling baru (DESC) agar aktivitas terkini tampil di atas
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Zebra-striping untuk keterbacaan tabel log yang panjang */
        tr:nth-child(even) {
        ...
        /* Badge timestamp berwarna biru muda */
        .badge-time {
        ...
        /* Pesan kosong jika belum ada log */
        .no-data {
            padding: 50px;
            text-align: center;
            color: #ccc;
            ...
            <table>
                ...
                <tbody>
                    ...
                    if (mysqli_num_rows($logs) > 0) {
                        // Loop setiap baris log dan tampilkan datanya
                        while ($row = mysqli_fetch_assoc($logs)) {
                            ?>
                            <tr>
                                <!-- Format waktu: dd Mon YYYY | HH:MM -->
                        ...
                        // Tampilkan pesan jika tabel log masih kosong
