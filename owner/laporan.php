...
// Default: tampilkan data dari awal bulan ini hingga hari ini
$tgl_awal = isset($_GET['tgl_awal']) ? $_GET['tgl_awal'] : date('Y-m-01');
$tgl_akhir = isset($_GET['tgl_akhir']) ? $_GET['tgl_akhir'] : date('Y-m-d');

// Query transaksi lunas (status='paid') dalam rentang tanggal yang dipilih
// JOIN ke tb_user untuk mendapatkan nama petugas yang menangani
...
$total_all = 0; // Akumulator total pendapatan untuk ditampilkan di stat banner
?>
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Grup tombol aksi di pojok kanan header */
        .btn-group {
            display: flex;
            gap: 12px;
        }
        ...
        /* Banner total omzet bergradasi gelap */
        .stat-banner {
        ...
        /* Ikon dekoratif transparan di belakang banner */
        .stat-banner i {
            position: absolute;
            right: -20px;
            bottom: -20px;
        ...
        /* Style khusus saat dicetak sebagai PDF (Ctrl+P) */
        @media print {
            @page {
                size: A4 landscape;
                margin: 1cm;
            ...
            /* Sembunyikan elemen non-laporan saat cetak */
            .sidebar,
            .card:first-of-type,
            .btn-group,
            .watermark-bg,
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="header-flex">
            <div>
                ...
                <!-- Tampilkan range tanggal yang aktif saat ini -->
                <p class="header-subtitle">
                    Periode: <?= date('d M Y', strtotime($tgl_awal)) ?> - <?= date('d M Y', strtotime($tgl_akhir)) ?>
                </p>
            </div>
            <div class="btn-group">
                <!-- Tombol ekspor ke Excel menggunakan fungsi JavaScript -->
        ...
        <div class="stat-banner">
            <div>
                <p style="text-transform: uppercase; letter-spacing: 2px; font-size: 13px; opacity: 0.8;">Total Omzet
                    Terkumpul</p>
                <!-- Nilai diisi oleh JavaScript setelah halaman selesai dimuat -->
            ...
            <table id="laporan-table">
                ...
                <tbody>
                    <?php while ($d = mysqli_fetch_assoc($data)) {
                        // Akumulasi total pendapatan seluruh transaksi yang ditampilkan
                        $total_all += $d['biaya'];
                        ?>
                        <tr>
                            ...
                            <td style="text-align: right; font-weight: 800; color: #4a4036;">Rp
                                <?= number_format($d['biaya'], 0, ',', '.') ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
    ...
    <script>
        // Perbarui tampilan total omzet di banner menggunakan nilai yang sudah dihitung PHP
        document.getElementById('total_display').innerText = "Rp <?= number_format($total_all, 0, ',', '.') ?>";

        // Fungsi ekspor tabel HTML ke format Excel (.xls) secara client-side.
        // Menggunakan pendekatan data URI dengan MIME type Excel untuk trigger download.
        function exportToExcel() {
            // Clone tabel agar styling asli tidak berubah
            var table = document.getElementById("laporan-table").cloneNode(true);

            // Terapkan style tambahan pada header dan sel untuk tampilan Excel yang rapi
            ...
            // Template HTML khusus dengan namespace Excel agar tabel terbaca dengan benar
            var template = `
            <html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="http://www.w3.org/TR/REC-html40">
            <head>
                <meta charset="UTF-8">
                <style>
                    /* Paksa kolom angka dibaca sebagai teks agar tidak diformat ulang Excel */
            ...
            // Buat link download dengan data URI base64 dan klik secara programatik
